...
- [ ] data collection
	- [x] find out what other data sources we can collect from
	- [x] (rafid) verify that the partner data is right
		- [x] make sure the infra is setup right 
	- [x] generate the url sets
	- [ ] generate synthetic data from google
