...
- [ ] Blast deployment: design the limit to ensure tokens don't get burned
- [ ] 
...
- [ ] 13:00 Wake up
	...
	- [ ] morning ritual
- [ ] 13:15 meditate
- [ ] 13:30 think through the tasks at hand
...
### Aws things to take down

-> prod 
1. spin down db and servers for alpine empower
2. look into why the config cost is so high 
3. 

-> Staging
1. all empower related stuff 
	1. db and instances
2. delete snapshots of old db
3. (3.5) delete ECR 
