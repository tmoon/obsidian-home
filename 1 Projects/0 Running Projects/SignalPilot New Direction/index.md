...
- [[From Wedge to Stack Collapse — Critique + Discipline]] **★ STRATEGIST-MODE AUDIT** — brutal critique of "collapse the BI stack" vision: 10 objections (uneven layer collapse; substrate not ours; identity moat; buyer fragmentation; runway mismatch; hubris; AI-progress dependency; switching costs; complexity scaling; Harvey-services ratchet). Honest probability tree (full collapse 3–5%; partial 15–25%; Phase 1 only 20–30%; services 20–30%; acquihire 15–20%). 5-phase wedge-then-overreach playbook with explicit kill conditions. **Internal: stack collapse. External: receipts. The over-reach is earned, not declared.**
