...
>
> **⚠️ Time-horizon nuance (2026-05-06):** The page's bullishness is *more defensible on a 10-year horizon than a 5-year one*. Per [[From Wedge to Stack Collapse — Critique + Discipline]] revisions (after Tarik pushback): the purpose-collapse of BI-analyst roles and Tableau/Looker/PowerBI installs is **directionally correct on a 10-year horizon** (Tarik's thesis is the dominant scenario by 2036). On 24-36 months, only ~10% categorical collapse probability. The strategic terrain we earn revenue in is the **3-7 year gap between purpose-collapse and job-collapse** — when the role no longer needs to exist but hasn't yet been eliminated. See [[From Wedge to Stack Collapse — Critique + Discipline]] § "The purpose-collapse vs job-collapse gap" for the time-stratified probability tree (5yr vs 10yr outcomes diverge meaningfully).
>
